...
meaningful_words = [
    word for word in text1 if word.casefold() not in stop_words
]
...
# text1.dispersion_plot(meaningful_problemWords)
...
# # with open ("data_upload/paragraph_problematic_trees.txt",'w') as file:
# #     file.write('\n'.join(new_tree))
