...
chapters_paragraphs = re.split('paper--end',rawtext_ACL)
...
tree = tree+tree
tree2 =[s.strip() for s in codecs.open("data_upload/paragraph_nonproblematic_trees.txt","r","ISO-8859-1").readlines()]
...
waikatoWriteArff(base.data_frame(dtm_syntax),file="prediction_method1.arff",class_col="class_label")
